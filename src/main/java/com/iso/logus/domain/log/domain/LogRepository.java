...
public interface LogRepository extends JpaRepository<Log, Long>{
	...
	@Query(value = "SELECT l FROM Log l WHERE l.team.id = :team_id AND (l.title = :keyword OR l.content = :keyword)")	
	Page<Log> findAllByTeamIdAndKeywordContaining(long teamId, String keyword, Pageable pageable);
}
